  	...
  	extend: {
        ...
        'crezia-orange': '#fca311',
  		...
  		boxShadow: {
  			...
  			glow: '0 0 20px -5px rgba(252, 163, 17, 0.4)',
  			'glow-lg': '0 0 40px -10px rgba(252, 163, 17, 0.3)',
  		...
  		keyframes: {
  			...
  			glow: {
  				'0%, 100%': {
  					boxShadow: '0 0 20px -5px rgba(252, 163, 17, 0.4)'
  				},
  				'50%': {
  					boxShadow: '0 0 40px -5px rgba(252, 163, 17, 0.6)'
  				}
  			},
  			float: {
  				'0%, 100%': {
